  ...
  const catalogs = {
    en: {
      ui: {
        ...
        inheritedContextFrom: 'From {parent} · forked {time}',
        inheritedContextSummary: '{raw} parent Raw Records at the fork point support {main} Main and {protocol} Protocol events. They remain owned by the parent and are not counted as this session\'s activity.',
    ...
    'zh-CN': {
      ui: {
        ...
        inheritedContextFrom: '来自 {parent} · 分叉于 {time}',
        inheritedContextSummary: '分叉点处的 {raw} 条父会话原始记录支持 {main} 个主时间线事件和 {protocol} 个协议层事件。它们仍归父会话所有，不计入本会话活动。',
