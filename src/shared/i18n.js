  ...
  const catalogs = {
    en: {
      ui: {
        ...
        codeModeRulesDescription: 'Set shared visibility, then refine it by safely declared requests. Counts are matching tool calls; request groups may overlap. The most visible matching rule wins.',
        codeModeAllOperations: 'All Code Mode tool calls',
        codeModeAllOperationsDescription: 'Grouped outer call and wait chain.',
        codeModeOperationCountHint: 'Matching Code Mode tool calls.',
        codeModeRequestRules: 'Declared request refinements',
        codeModeRequestRulesDescription: 'Source declarations only; they do not prove that a nested tool ran.',
        codeModeRequestTypeCount: '{count} request types',
        codeModeRequestCountHint: 'Declared request types; one tool call may appear under more than one type.',
        codeModeRequestCurrentGroup: 'Current requests',
        codeModeRequestHistoricalGroup: 'Other / historical requests',
        noCodeModeRequestRules: 'No safely declared requests in this session.',
        inheritOtherRules: 'Inherit other rules',
        ...
        kindGroupCommonWorkName: 'Common work',
        kindGroupCommonWorkDescription: 'Commands, user shell commands, patches, and web searches.',
        ...
        kindGroupToolsAndInternalsName: 'Tools and internals',
        kindGroupToolsAndInternalsDescription: 'Lower-frequency tool, lifecycle, and diagnostic event types.',
      ...
      foldingCondition: {
        ...
        codeModeOperation: ['Code Mode tool call', 'An outer Code Mode tool call grouped with its wait chain.'],
    ...
    'zh-CN': {
      ui: {
        ...
        codeModeRulesDescription: '先设置共用可见性，再按安全声明的请求细分。计数表示匹配的工具调用，各请求分组可以重叠；命中多条规则时采用最可见状态。',
        codeModeAllOperations: '全部 Code Mode 工具调用',
        codeModeAllOperationsDescription: '由外层调用及其轮询链组成。',
        codeModeOperationCountHint: '匹配的工具调用数。',
        codeModeRequestRules: '按声明请求细分',
        codeModeRequestRulesDescription: '只表示源码声明；不证明嵌套工具已经运行。',
        codeModeRequestTypeCount: '{count} 类请求',
        codeModeRequestCountHint: '声明请求类型数；一次工具调用可能同时属于多个类型。',
        codeModeRequestCurrentGroup: '当前请求',
        codeModeRequestHistoricalGroup: '其他 / 历史请求',
        noCodeModeRequestRules: '当前 session 中没有可安全识别的声明请求。',
        inheritOtherRules: '继承其他规则',
        historicalRule: '历史规则',
        kindGroupConversationPlanningName: '对话与计划',
        kindGroupConversationPlanningDescription: '用户可见的消息、计划和目标状态。',
        kindGroupCommonWorkName: '常见工作',
        kindGroupCommonWorkDescription: '命令、用户命令行命令、文件补丁和网页搜索。',
        kindGroupIssuesRisksName: '问题与风险',
        kindGroupIssuesRisksDescription: '通常值得关注的错误和警告。',
        kindGroupToolsAndInternalsName: '工具与内部事件',
        kindGroupToolsAndInternalsDescription: '较低频的工具、生命周期和诊断事件类型。',
      ...
      foldingCondition: {
        ...
        codeModeOperation: ['Code Mode 工具调用', '由外层 Code Mode 工具调用及其轮询链分组得到。'],
