  ...
  const catalogs = {
    en: {
      ui: {
        ...
        searchPlaceholder: 'Find in current session',
        ...
        activeSearchContext: 'Active search context',
        searchOperatorMissingValue: '{operator}: requires a value.',
        searchOperatorInvalidValue: '{operator}: does not accept “{value}”.',
        eventTypeSessionTotal: 'Event type (current session total)',
        eventTypeProjectTotal: 'Event type (entire project total)',
        kind: 'Kind',
        status: 'Status',
        layer: 'Layer',
        file: 'File',
        ...
        matchCount: '{current} / {jumpTotal} discovered jump targets · {fullTextTotal} full-text occurrences; loading or expanding can add targets',
    ...
    'zh-CN': {
      ui: {
        ...
        searchPlaceholder: '在当前 session 中查找',
        ...
        searchOptions: '搜索选项',
        searchFilters: '搜索筛选',
        activeSearchContext: '当前搜索上下文',
        searchOperatorMissingValue: '{operator}: 需要填写值。',
        searchOperatorInvalidValue: '{operator}: 不接受“{value}”。',
        eventTypeSessionTotal: '事件类型（当前 session 总数）',
        eventTypeProjectTotal: '事件类型（整个项目总数）',
        kind: '类型',
        status: '状态',
        layer: '层级',
        file: '文件',
        ...
        loading: '加载中...',
        noMatches: '无匹配',
        matchCount: '{current} / {jumpTotal} 个已发现跳转目标 · {fullTextTotal} 处全文命中；加载或展开内容可增加目标数',
