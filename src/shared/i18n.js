  ...
  const catalogs = {
    en: {
      ui: {
        ...
        globalLayerValue: 'Global Layer: {value}',
        mainTimelineShort: 'Main',
        removeFilter: 'Remove {label} filter',
        noStructuredFilters: 'No structured filters. Add one to narrow events.',
        searchResultsBreakdown: 'Search results breakdown',
        clearAll: 'Clear all',
        clearAllSearchTitle: 'Clear query and filters; keep scope and Layer',
        searchTargetsMayGrow: 'Loading or expanding timeline content can discover more jump targets.',
    ...
    'zh-CN': {
      ui: {
        ...
        currentSessionScopeShort: '当前',
        entireProjectScopeShort: '项目',
        searchScopeValue: '搜索范围：{value}',
        searchFilters: '搜索筛选',
        searchParameters: '搜索参数',
        escapeToClose: '按退出键关闭',
        ...
        globalLayerValue: '全局层级：{value}',
        mainTimelineShort: '主线',
        removeFilter: '移除{label}筛选',
        noStructuredFilters: '没有结构化筛选。添加筛选可缩小事件范围。',
        searchResultsBreakdown: '搜索结果明细',
        clearAll: '全部清除',
        clearAllSearchTitle: '清除查询与筛选；保留范围和层级',
        searchTargetsMayGrow: '加载或展开时间线内容可能发现更多跳转目标。',
