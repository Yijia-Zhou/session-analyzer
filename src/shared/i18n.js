  ...
  const catalogs = {
    en: {
      ui: {
        ...
        projectSearchPrompt: 'Enter text or add a file, kind, status, or Code Mode request filter to search the entire project.',
        ...
        codeModeRequestRules: 'Code Mode requests (declared)',
        codeModeRequestRulesDescription: 'Rules apply to safely projected requests declared in Code Mode source; they do not assert execution.',
        codeModeRequestCurrentGroup: 'Current requests',
        codeModeRequestHistoricalGroup: 'Other / historical requests',
        noCodeModeRequestRules: 'No Code Mode request catalog entries or historical rules.',
        ...
        viewEnclosingOperation: 'View enclosing Code Mode operation',
        enclosingOperation: 'Enclosing Code Mode operation',
        inspectEnclosingOperation: 'Inspect operation',
        rawRefs: 'Raw refs',
      ...
      kind: {
        ...
        code_mode_operation: 'Code Mode operation',
      ...
      foldingCondition: {
        ...
        codeModeOperation: ['Code Mode operation', 'Operations grouped from a Code Mode exec call and its wait chain.'],
    ...
    'zh-CN': {
      ui: {
        ...
        projectSearchPrompt: '输入文本，或添加文件、类型、状态、Code Mode 请求筛选，以搜索整个项目。',
        ...
        codeModeRequestRules: 'Code Mode 请求（声明）',
        codeModeRequestRulesDescription: '规则作用于 Code Mode 源码中安全投影出的声明请求；不表示请求已执行。',
        codeModeRequestCurrentGroup: '当前请求',
        codeModeRequestHistoricalGroup: '其他 / 历史请求',
        noCodeModeRequestRules: '当前目录没有 Code Mode 请求，也没有历史规则。',
        ...
        viewEnclosingOperation: '查看所属代码模式操作',
        enclosingOperation: '所属代码模式操作',
        inspectEnclosingOperation: '检查操作',
        rawRefs: '原始引用',
      ...
      foldingCondition: {
        ...
        codeModeOperation: ['代码模式操作', '由代码模式执行入口及其轮询链分组得到的操作。'],
