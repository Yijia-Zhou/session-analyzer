...
test('npm pack manifest contains only approved runtime and documentation files', () => {
  ...
  const approvedFiles = [
    ...
    'server.js',
    'skills/history-retrieval/SKILL.md',
    'src/history-cli.js',
    'src/history-server.js',
    'src/history-service.js',
    'src/history-presentation.js',
    ...
    'src/codex-background-terminal.js',
    'src/codex-terminal-continuations.js',
    ...
    'src/codex-persisted-history.js',
    'src/codex-rollout-storage.js',
    'src/codex-rollout-snapshots.js',
    'src/folding.js',
    ...
    'src/shared/background-terminal-presentation.js',
