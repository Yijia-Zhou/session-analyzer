...
- [ ] M1 — implement grouped retry Protocol lifecycle, source-backed synthetic fixture, Detail, parity/freshness/fallback tests, and real five-pair replay gate. / 实现 grouped retry Protocol 生命周期、源码支撑合成 fixture、Detail、parity／freshness／fallback 测试及真实五对 replay 门禁。
